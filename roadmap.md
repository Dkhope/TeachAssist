...
- [x] Show a prioritised summary of today’s tasks on the dashboard with a link to Task Planner.
- [x] Persist planner tasks across pages and verify the dashboard-to-planner flow.
